# 🤖 FSM-Based Obstacle Avoidance using ROS 2
...
| ------- | ------------------------ | ------------ |
| FORWARD | Distance > 0.5 m         | Move forward |
| TURN    | 0.2 m < Distance ≤ 0.5 m | Rotate       |
| STOP    | Distance ≤ 0.2 m         | Stop         |
...
(Add a screen recording or simulation screenshot here)
